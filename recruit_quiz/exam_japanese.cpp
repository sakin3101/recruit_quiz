...
QuestionList CreateSynonymExam()
{
	...
	for (int i = 0; i < quizCount; i++) {
		...
		//	出題する類義語を選択
		const auto& e = data[indices[i]];
		const int object = uniform_int_distribution<>(0, e.count - 2)(rd);
